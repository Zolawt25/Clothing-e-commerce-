...
const SearchBar = () => {
  return (
    <div className=' text-center bg-[image:url(/img/banner/b1.jpg)] bg-cover bg-center py-14 px-4 sm:px-0'>
        <p className=' text-gray-50 text-5xl sm:text-6xl font-[500]'>#stayhome</p>
        <p className=' sm:text-lg text-gray-300 font-[400]'>Save more with coupons & up to 70% off!</p>
