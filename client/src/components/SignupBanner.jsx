...
const SignupBanner = () => {
  return (
    <div className='bg-[image:url(/img/banner/b14.png)] bg-no-repeat bg-[left_10rem_bottom_-10rem] bg-[#041D44] px-10 sm:px-16 md:px-24 py-10 flex items-center mb-12 flex-col lg:flex-row text-center lg:text-left'>
