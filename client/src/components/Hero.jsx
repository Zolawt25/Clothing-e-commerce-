...
const Hero = () => {
  return (
    <div className='flex justify-center bg-navbg'>
      <div className='h-vh90 w-full max-w-[1400px] px-10 sm:px-24 flex items-center bg-[image:url(/img/hero4.png)] bg-hero bg-cover'>
      <div>
